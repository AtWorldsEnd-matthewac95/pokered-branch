...
; - MoveSoundTable (see data/moves/sfx.asm)
	...
	const SCRATCH      ; 0a
	const SAND_RAKE    ; 0b
	const FLAME_WHEEL  ; 0c
	const ROCK_TACKLE  ; 0d
	const SWORDS_DANCE ; 0e
	const CUT          ; 0f
	const GUST         ; 10
	const WING_ATTACK  ; 11
	const NATURALFORCE ; 12
	const FLY          ; 13
	const BULLET_SEED  ; 14
	const SLAM         ; 15
	const VINE_WHIP    ; 16
	const STOMP        ; 17
	...
	const BARRIER      ; 70
	const POISON_FANG  ; 71
	const HAZE         ; 72
	const WILL_O_WISP  ; 73
	const FAKE_TEARS   ; 74
	const BIDE         ; 75
	const METRONOME    ; 76
	const MIRROR_MOVE  ; 77
	const SELFDESTRUCT ; 78
	const DRAGON_ROAR  ; 79
	const LICK         ; 7a
	const SCARY_FACE   ; 7b
	const SLUDGE       ; 7c
	const DRAGONFIRE   ; 7d
	const FIRE_BLAST   ; 7e
	const BOULDERCRASH ; 7f
	const POISON_JAB   ; 80
	const SWIFT        ; 81
	const ICY_WIND     ; 82
	const IRON_DEFENSE ; 83
	const EXTRASENSORY ; 84
	const AMNESIA      ; 85
