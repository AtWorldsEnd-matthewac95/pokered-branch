	...
	db CONFUSION, HAZE, PSYBEAM, SWIFT ; level 1 learnset
	...
	tmhm MEGA_PUNCH,   PAY_DAY,      BUBBLEBEAM,   DUST_DEVIL,   MEGA_KICK,    \
	     ...
	     FIRE_BLAST,   SCARY_FACE,   THUNDERPUNCH, SLUDGE,       REST,         \
	     THUNDER_WAVE, EXTRASENSORY, FIRE_PUNCH,   TRI_ATTACK,   SUBSTITUTE,   \
	     STRENGTH,     FLASH
	; end
